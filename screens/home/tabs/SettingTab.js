  ...
  return (
    <ScrollView style={styles.account}>
      ...
      <View style={styles.account_hotro}>
        ...
        <View style={styles.account_hotro_dangxuat}>
      ...
      <View style={styles.account_info}>
        ...
        <View style={styles.account_info_trnThienQu}><Text style={{ "marginTop": -4, "color": "rgba(9, 44, 76, 1)", "fontSize": 20, "fontWeight": "400", "fontStyle": "normal", "fontFamily": "Roboto", "textAlign": "center", "lineHeight": 22 }}>Trần Thiên Quý</Text></View>
